...
if (isset($_POST['action'])) {
	...
	// get topup plus options
	$options = get_option('topup_plus');
...
<head>
	...
	<script language="javascript" type="text/javascript" src="topup-plus.js"></script>
	<base target="_self" />
	<style type="text/css">
		#topupplus .panel_wrapper, #topupplus div.current {
			height: 265px;
			padding-top: 5px;
		}
	...
	<title><?php echo _e('TopUp Plus','topupplus'); ?></title>
</head>

<body id="topupplus" onload="<?php $tab = (isset($_GET['tab'])) ? $_GET['tab'] : $_POST['tab']; echo "mcTabs.displayTab('".$tab."_tab','".$tab."_panel');"; if ($_GET['tab']=='portal') echo "document.forms.portal_form.vid.style.backgroundColor = '#f30';" ?>tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">

 <div class="tabs">
    <!--<ul>
      <li id="portal_tab" class="current"><span><a href="javascript:mcTabs.displayTab('portal_tab','portal_panel');" onmousedown="return false;"><?php echo _e('Portal video','topupplus'); ?></a></span></li>
      <?php if ($attachments) { ?><li id="select_tab"><span><a href="javascript:mcTabs.displayTab('select_tab','select_panel');" onmousedown="return false;"><?php echo _e('Local video','topupplus'); ?></a></span></li><?php } ?>
      <li id="upload_tab"><span><a href="javascript:mcTabs.displayTab('upload_tab','upload_panel');" onmousedown="return false;"><?php echo _e('Upload video','topupplus'); ?></a></span></li>
      <li id="remote_tab"><span><a href="javascript:mcTabs.displayTab('remote_tab','remote_panel');" onmousedown="return false;"><?php echo _e('Video URL','topupplus'); ?></a></span></li>
    </ul>-->
  </div> 
...
<div id="portal_panel" class="current">
	<form name="portal_form" action="#">
		<table border="0" cellpadding="4" cellspacing="0">
			<tr>
			<td nowrap="nowrap" style="text-align:right;"><?php echo _e('Select video portal:','topupplus'); ?></td>
			<td>
          ...
          <tr>
            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Insert video ID:','topupplus'); ?></td>
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><?php echo _e('Show video without link','topupplus'); ?></td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Link text:','topupplus'); ?></td>
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
          ...
          <tr>
            <td>
	    <input type="submit" id="portal_insert" name="insert" value="<?php echo _e('Insert','topupplus'); ?>" onclick="tup_checkData(this.form);" />
            </td>
            <td align="right"><input type="button" id="portal_cancel" name="cancel" value="<?php echo _e('Cancel','topupplus'); ?>" onclick="tinyMCEPopup.close();" /></td>
          </tr>
        </table>
...
?>
  <div id="select_panel" class="panel">
    <form name="select_form" action="#">
        <table border="0" cellpadding="4" cellspacing="0">
          <tr>
            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Select video file:','topupplus'); ?></td>
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
          ...
          <tr>
            <td><input type="submit" id="select_insert" name="insert" value="<?php echo _e('Insert','topupplus'); ?>" onclick="tup_checkData(this.form);"/>
            </td>
            <td align="right"><input type="button" id="select_cancel" name="cancel" value="<?php echo _e('Cancel','topupplus'); ?>" onclick="tinyMCEPopup.close();" /></td>
          </tr>
        </table>
  ...
  <div id="upload_panel" class="panel">
    <form name="upload_form" enctype="multipart/form-data" method="post" action="#">
        <table border="0" cellpadding="4" cellspacing="0">
          ...
          <?php } ?>
          <tr>
            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Local video file:','topupplus'); ?></td>
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
          ...
          <tr>
            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Title:','topupplus'); ?></td>
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
          ...
          <tr>
            <td nowrap="nowrap" style="text-align:right;"><?php echo _e('Description:','topupplus'); ?></td>
            <td>
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
          ...
          <tr>
            <td><input type="submit" id="upload_insert" name="insert" value="<?php echo _e('Upload','topupplus'); ?>" />
            </td>
            <td align="right"><input type="button" id="upload_cancel" name="cancel" value="<?php echo _e('Cancel','topupplus'); ?>" onclick="tinyMCEPopup.close();" /></td>
          </tr>
        </table>
